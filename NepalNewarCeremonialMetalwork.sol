...
contract NepalNewarCeremonialMetalwork {

    struct MetalworkTechnique {
        string region;        // Kathmandu Valley, Patan, Bhaktapur
        string community;     // Newar metalworking guilds / neighborhoods
        string techniqueName; // lost-wax casting, repoussé, gilding, etc.
        string materialType;  // bronze, copper, brass, gold leaf
        string culturalNote;  // documented ethnographic or historical fact
        string ritualUse;     // vajra, ghanta, torana, votive figure, etc.
        address creator;
        uint256 likes;
        uint256 dislikes;
        uint256 createdAt;
    ...
    MetalworkTechnique[] public techniques;
    ...
    function voteTechnique(uint256 id, bool like) external {
        ...
        MetalworkTechnique storage t = techniques[id];
